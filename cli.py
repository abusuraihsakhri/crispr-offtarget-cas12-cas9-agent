"""
Command Line Interface for Crispr Offtarget Cas12 Cas9 Agent.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="crispr-offtarget-cas12-cas9-agent", description="Crispr Offtarget Cas12 Cas9 Agent")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  CRISPR OFFTARGET CAS12 CAS9 AGENT")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Crispr Offtarget Cas12 Cas9 Agent Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Crispr Offtarget Cas12 Cas9 Agent API server on http://{args.host}:{args.port}")
