"""
FastAPI REST API Server for CRISPR-Scan Pro: Cas9 / Cas12a CFD Score & Off-Target Cutting Predictor.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="CRISPR-Scan Pro: Cas9 / Cas12a CFD Score & Off-Target Cutting Predictor",
            description="Calculates Cutting Frequency Determination (CFD) scores, MIT specificity scores, and PAM fidelity across genomic DNA off-target locus alignments.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "crispr-offtarget-cas12-cas9-agent", "domain": "Computational Chemistry & AI Drug Discovery", "version": "2.0.0-FRONTIER"}
