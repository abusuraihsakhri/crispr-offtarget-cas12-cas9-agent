"""
Command-Line Interface for CRISPR-Scan Pro: Cas9 / Cas12a CFD Score & Off-Target Cutting Predictor.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="crispr-offtarget-cas12-cas9-agent", description="CRISPR-Scan Pro: Cas9 / Cas12a CFD Score & Off-Target Cutting Predictor")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  CRISPR-SCAN PRO: CAS9 / CAS12A CFD SCORE & OFF-TARGET CUTTING PREDICTOR")
        print(f"  Domain: Computational Chemistry & AI Drug Discovery | Standard: Doench 2016 / Hsu 2013 CRISPR Algorithms")
    ...
    if args.command == "serve":
        try:
            ...
            app = create_app()
            if app:
                print(f"Starting CRISPR-Scan Pro: Cas9 / Cas12a CFD Score & Off-Target Cutting Predictor on http://{args.host}:{args.port}")
