"""
Data Models & Telemetry Definitions for CRISPR-Scan Pro: Cas9 / Cas12a CFD Score & Off-Target Cutting Predictor.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Doench 2016 / Hsu 2013 CRISPR Algorithms"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
